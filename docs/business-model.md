# Business Model: Manufacture of corrugated paper and paperboard and of containers of paper and paperboard
...
## Classification
- Repository: `cloud-itonami-isic-1702` ([github.com/cloud-itonami/cloud-itonami-isic-1702](https://github.com/cloud-itonami/cloud-itonami-isic-1702))
- ISIC Rev.5: `1702` — Manufacture of corrugated paper and paperboard and of containers of paper and paperboard
- Domain: `:corrugated-packaging/plant-operations`
- Social impact: :worker-safety :environmental-stewardship :resource-efficiency
- Actor: `:corrugated-packaging-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :corrugated-packaging/plant-operations — who wants
...
One managed tenant (:corrugated-packaging/plant-operations):
...
- Do not bypass the `:corrugated-packaging-plant-operations-governor` for production decisions.
