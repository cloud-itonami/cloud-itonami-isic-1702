# Operator Quickstart — Manufacture of corrugated paper and paperboard and of containers of paper and paperboard

Shortest path from clone to a verified local dry-run for **ISIC 1702** (`cloud-itonami-isic-1702`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1702.git
cd cloud-itonami-isic-1702
```
...
- Blueprint governor key: `corrugated-packaging-plant-operations-governor`
- Likely source path: `corrugated.governor.cljc`
